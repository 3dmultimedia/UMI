...
2. Распаковать архив, скопировать файлы на сервер в корневую директорию.
3. Запустить скрипт установки модуля install_ik.php, должен быть скопирован вместе с модулем в корень сайта. Зайти в браузере по адресу: http://Ваш_сайт/install_ik.php, при успехе будет выведено сообщение "Готово!".
...
5. В личном кабинете "Интеркассы", в разделе "Интерфейс", введите в поля URL-ов взаимодействия:
